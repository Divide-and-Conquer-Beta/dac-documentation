...
12th January 2024
- (Medik) Update Warg Riders/Scouts unit info card
- (b0gia) Added biographies and custom portraits for Dori, Dwalin and Gloin (Thank you Swan)
- (b0gia) Dori and Dwalin now spawn for Erebor when Durin's Hall is rebuilt. They were removed from the Ered Luin attacks.
- (b0gia) Added Bofur as a diplomat for Erebor at game start
- (b0gia) Moved Gleowine further south to help prevent Anduin regicide
- (Reeveli) Added Rohan banner texture for AV since the former can now get some Framsguard from Framsburg
- (Medik) Added rebuilt Pillar of Umbar building line
